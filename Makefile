...
APPNAME = "Callisto"
else ifeq ($(CHAIN),callistot)
APP_LOAD_PARAMS += --path "44'/20729'"
DEFINES += CHAINID_UPCASE=\"CALLISTOTEST\" CHAINID_COINNAME=\"CLOT\" CHAIN_KIND=CHAIN_KIND_CALLISTO_TEST CHAIN_ID=20729
APPNAME = "Callisto Test"
